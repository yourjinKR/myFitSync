...
public class PaymentController {
     ...
     * @return 구독 상태 정보
     */
    @GetMapping("/subscription/{member_idx}")
    public ResponseEntity<Map<String, Object>> getSubscriptionStatus(HttpSession session, @PathVariable int member_idx) {
        ...
        try {
            ...
            } else if (memberIdx != member_idx) {
            	log.warn("로그인과 세션 memberIdx 불일치");
            	return createErrorResponse(HttpStatus.UNAUTHORIZED, "구독정보와", "INVALID_SUBSCRIPTION");
            }
