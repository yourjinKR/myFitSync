...
const KaKaoPayTest = () => {
    ...
    return (
        <div>
            ...
            <ButtonSubmit onClick={() => PaymentUtil.payBillingKey({method_idx: 2})}>빌링키 결제</ButtonSubmit>
            ...
            <ButtonSubmit onClick={() => handleScheduleBillingKey({method_idx: 10})}>⏰ 결제 예약 (1시간 후)</ButtonSubmit>
